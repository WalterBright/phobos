...
SRC_DOCUMENTABLES = index.d $(addsuffix .d,$(STD_MODULES) $(STD_NET_MODULES) $(STD_BUFFER_MODULES) $(STD_DIGEST_MODULES) $(EXTRA_DOCUMENTABLES))
...
STD_BUFFER_MODULES = $(addprefix std/buffer/, scopebuffer)
...
D_MODULES = $(STD_MODULES) $(EXTRA_MODULES) $(STD_NET_MODULES) \
    $(STD_DIGEST_MODULES) $(STD_BUFFER_MODULES)
